...
<div class="hero-image">
    <div class="hero-content">
        <div class="col-md-4 hero-text" style="color: black!important;">
            <h3>
                Welcome to the Imran Collection
            </h3>
            <p>Collection of world class clothes.</p>
            <button class="btn custom-border my-2 my-sm-0" style="color: black!important;">Shop</button>
...
<div class="container">
    <div class="content-head">
        <h2 style="text-align:center; font-weight: bold">Imran Collection Products</h2>
